$(document).ready(function() {
    ...
    $("body").append('<div id="carouselbg" style="position: fixed; top: 0; left: 0px; bottom: 0px; right: 0px; background-color: #FFF;"></div>')

    $("#carouselbg").append('<div id="imgcarousel" class="carousel slide" data-ride="carousel" style="position: fixed; top: 10%, bottom: 10%; left: 10%; right: 10%" ></div>');
    ...
    for (i = 0; i < numitems; i++) {
        ...
        $(".carousel-inner").append('<center><img src="' + imglist[i] + '" style="max-width: 70%; max-height: 7%"></center>')
